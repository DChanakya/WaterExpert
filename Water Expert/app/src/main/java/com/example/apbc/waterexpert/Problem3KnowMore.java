...
public class Problem3KnowMore extends AppCompatActivity {
    int selectedOption;
    ImageView img, img1;
    TextView textView, textView1;
    Button treatment;
    LinearLayout makeVisible, treatmentlay, treatbuttonlay;
    //Zooming
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_problem3_know_more);

        textView = (TextView) findViewById(R.id.problem3KnowMoreResultText);
        textView1 = (TextView) findViewById(R.id.problem3KnowMoreResultText1);
        makeVisible = (LinearLayout) findViewById(R.id.problem3KnowMoreResultLayout);
        treatmentlay = (LinearLayout) findViewById(R.id.problem3KnowMoreResultLayout1);
        treatment = (Button) findViewById(R.id.problem3KnowMoretreatment);
        img = (ImageView) findViewById(R.id.problem3KnowMoreImage);
        treatbuttonlay = (LinearLayout) findViewById(R.id.treatbutlay);
        img1 = (ImageView) findViewById(R.id.problem3KnowMoreImage1);
        ...
        selectedOption = Integer.valueOf(DataTransfer.option);
        if (selectedOption == 1) {
            //Before Treatment
